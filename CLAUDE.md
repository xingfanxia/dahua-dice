...
| Test | Vitest (79 unit/integration) + Playwright e2e (happy-path / reconnect / extensions / player2-flow / full-game-to-rematch / solo / palifico / axe a11y; 26 tests, chromium + webkit) |
...
Done (2026-06-10 — round-2 audit + solo mode; branch `fix/playability-audit-r2-2026-06-09`, 79 unit + 26 e2e green ×2):
