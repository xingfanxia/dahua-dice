...
| Test | Vitest (76 unit/integration) + Playwright e2e (happy-path / reconnect / extensions / axe a11y; 14 tests, chromium + webkit) |
...
All unit-tested (76 unit + integration, full game simulated end-to-end via `round.ts`). Live path covered by Playwright e2e incl. a 通杀 journey.
...
components/
├── dice/             # Dice / DiceCup / DiceCanvas / DiceScene (dynamic ssr:false) / DiceFallback (2D SVG, WebGL2-absent) / dice-materials
...
tests/                # unit + integration (76) + e2e/ (14 Playwright, chromium + webkit)
